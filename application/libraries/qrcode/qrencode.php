...
class QRcode {
    ...
    {
        $enc = QRencode::factory($level, (int)$size, $margin, $back_color, $fore_color);
    ...
    {
        $enc = QRencode::factory($level, (int)$size, $margin);
    ...
    {
        $enc = QRencode::factory($level, (int)$size, $margin, $back_color, $fore_color, $cmyk);
...
class QRencode {
    ...
    {
        $enc = new QRencode();
        $enc->size = (int)$size; // Konversi $size ke integer
        $enc->margin = (int)$margin; // Konversi $margin ke integer untuk konsistensi
    ...
    public function encodePNG($intext, $outfile = false, $saveandprint = false) 
    {
        try {
            ...
            QRimage::png($tab, $outfile, min(max(1, (int)$this->size), $maxSize), $this->margin, $saveandprint, $this->back_color, $this->fore_color);
    ...
    public function encodeEPS($intext, $outfile = false, $saveandprint = false) 
    {
        try {
            ...
            QRvect::eps($tab, $outfile, min(max(1, (int)$this->size), $maxSize), $this->margin, $saveandprint, $this->back_color, $this->fore_color, $this->cmyk);
    ...
    public function encodeSVG($intext, $outfile = false, $saveandprint = false) 
    {
        try {
            ...
            QRvect::svg($tab, $outfile, min(max(1, (int)$this->size), $maxSize), $this->margin, $saveandprint, $this->back_color, $this->fore_color);
