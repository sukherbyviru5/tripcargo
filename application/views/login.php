					...
					<form action="<?php echo base_url('login/login')?>" method="post" id="login-form" class="smart-form client-form" style=" z-index: 1;">
                        ...
                        <label id="lblWelcomeTo"> to Trip Cargo Information Gateway</label>
    						...
    						<footer>
    							...
    							<a class="btn btn-link" href="https://api.whatsapp.com/send/?phone=62881080899678&text=anda+lupa+kata+sandi+atau+password+(+ketik+user+id+)+&+nomor+hanpone+%3F+&type=phone_number&app_absent=0" role="button">Forgot password?</a>
