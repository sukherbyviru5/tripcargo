...
<head>
    ...
    <link rel="stylesheet" type="text/css" media="screen"
        href="<?php echo base_url(); ?>assets/css/smartadmin-production-plugins.min.css">
    <link rel="stylesheet" type="text/css" media="screen"
        href="<?php echo base_url(); ?>assets/css/smartadmin-production.min.css">
  ...
  specific styles this will also ensure you retrain your customization with each SmartAdmin update. -->
    ...
    <!-- FAVICONS -->
    <link rel="shortcut icon" href="<?php echo base_url(); ?>assets/img/icon-trip.png" type="image/x-icon">
   ...
   Ref: https://developer.apple.com/library/ios/documentation/AppleApplications/Reference/SafariWebContent/ConfiguringWebApplications/ConfiguringWebApplications.html -->
    ...
    <link rel="apple-touch-icon" sizes="120x120"
        href="<?php echo base_url(); ?>assets/img/splash/touch-icon-iphone-retina.png">
    <link rel="apple-touch-icon" sizes="152x152"
        href="<?php echo base_url(); ?>assets/img/splash/touch-icon-ipad-retina.png"> <!-- oke-->
    ...
    <link rel="apple-touch-startup-image" href="<?php echo base_url(); ?>assets/img/splash/iphone.png"
...
<body>
    ...
    <!-- MAIN CONTENT -->
    <div class="container">
        <div class="col-11 col-sm-10 col-md-4 mx-auto" style="margin-top: 50px;">
            <span id="logo" class="d-block text-center">
                <img src="https://tripcargoid.com/assets/images/logo-sancargo.png" alt="Trip Cargo"
                    style="width: 200px; display: block; margin: 10px auto;">
            </span>
            <div class="well no-padding">
                <form action="<?php echo base_url('login/login'); ?>" method="post" id="login-form" class="smart-form client-form"
                    style=" z-index: 1;">
                    <header>
                        <b>Please Sign In</b>
                    ...
                    <fieldset>
                        ...
                        <section>
                            ...
                            <label class="input"> <i class="icon-append fa fa-user"></i>
                                ...
                                <b class="tooltip tooltip-top-right"><i class="fa fa-user txt-color-teal"></i> User
                                    Name</b></label>
                        </section>
    ...
    <br>
   	 <a id="" href="https://tripcargoid.com/login" data-toggle="dropdown"><span class="hidden-xs"> Regristrasi</span></a-->
                            <!-- <a class="btn btn-link"
                                href="https://api.whatsapp.com/send/?phone=62881080899678&text=anda+lupa+kata+sandi+atau+password+(+ketik+user+id+)+&+nomor+hanpone+%3F+&type=phone_number&app_absent=0"
