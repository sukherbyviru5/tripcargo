...
<div id="ribbon">
	<ol class="breadcrumb">
		<li>Home</li><li>Asal Pengiriman</li>
	</ol>
</div>	
<div id="content">
			...
			<article class="col-sm-12 col-md-12 col-lg-8">
				...
				<div class="jarviswidget" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false">
					...
					<header>
						...
						<h2>Daftar Asal Pengiriman (Pengirim) <span id="loading2"></span></h2>
						...
						<table id="table" class="table table-striped table-bordered table-hover" width="100%">
								<thead>			                
									<tr>
										...
										<th data-class="phone" ><i class="fa fa-fw fa-tag text-muted hidden-md hidden-sm hidden-xs"></i> Asal</th>
...
// DO NOT REMOVE : GLOBAL FUNCTIONS!
	...
	function edit(id)
	{
		...
		$.ajax({
			url : "<?php echo base_url().'cadmin/home/asal_edit';?>/"+id,
			type: "GET",
			dataType: "JSON",
	...
	function hapus(id) {
			...
			buttons : [{
				...
				click : function() {
					...
					$.ajax({
							type: "POST",
							url : "<?php echo base_url().'cadmin/home/asal_hapus';?>/"+id,
							data: kode,
							// dataType: "JSON",
							beforeSend: function(){
							   // $("#loaderDiv").show();
	...
	*/
	...
	function save()
	{
		...
		var url;
			...
			url = "<?php echo base_url().'cadmin/home/asal_add';?>";
...
$(document).ready(function() {
	...
	table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('cadmin/home/asal_ajax_list')?>",
            "type": "POST"
        },
