     ...
     -->
                                            ...
                                            <div class="tab-pane active" id="tab1">
                                                ...
                                                <div class="step-content">
                                                    <div class="form-group has-warning">
                                                        <label class="col-md-2 control-label"><b>Reg
                                                                Pengirim</b></label>
                                                        <div class="col-md-2">
                                                            <div class="input-group">
                                                                <button class="button-flat-outline" name="cari"
                                                                    onclick="load_pengirim()"><i
                                                                        class="fa fa-search"></i> Cari pengirim</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="form-group has-warning">
                                                        ...
                                                        <div class="col-md-4">
                                                            ...
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control"
                                                                    placeholder="Nama Lengkap Pengirim" type="text"
                                                                    name="nama" id="nama"
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><i
                                                                        class="fa fa-building fa-fw"></i></span>
                                                                <input class="form-control"
                                                                    placeholder="Dept / Perusahaan" type="text"
                                                                    name="dept" id="dept"
                                                                    onkeyup="this.value = this.value.toUpperCase()">
                                                                <span class="input-group-addon"><i
                                                                        class="fa fa-check"></i></span>
                                                    ...
                                                    <div class="form-group has-warning">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                ...
                                                                <textarea class="form-control" cols="20" rows="3" maxlength="150" placeholder="Alamat lengkap pengirim"
                 ...
                 <span class="input-group-addon"><i class="fa fa-check"></i></span>
                                                    ...
                                                    <div class="form-group has-warning">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control"
                                                                    placeholder="Telp/hp Pengirim" type="tel"
                                                                    name="telp" id="telp">
                                                                <span class="input-group-addon"><i
                                                                        class="fa fa-check"></i></span>
                                                            </div>
                                                        ...
                                                        <span class="hidden-xs"><!--tidak tampil di hp-->
                                                            <div class="col-md-3">
                                                                <div class="input-group">
                                                                    ...
                                                                    <input class="form-control"
                                                                        placeholder="Email Pengirim" type="email"
                                                                        name="email" id="email"
                                            ...
                                            <div class="tab-pane" id="tab2">
                                                <br>
                                                <h3><strong>Step 2</strong> - Data Penerima</h3>
                                                <div class="step-content">
                                                    <div class="form-group has-warning">
                                                        <label class="col-md-2 control-label"><b>Reg.
                                                                Penerima</b></label>
                                                        <div class="col-md-4">
                                                            <div class="input-group">
                                                                ...
                                                                <button class="button-flat-outline" name="cari2"
                                                                    onclick="load_penerima()"><i
                                                                        class="fa fa-search"></i> Cari Penerima</span>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><i
                                                                        class="fa fa-user fa-fw"></i></span>
                                                                <input class="form-control"
                                                                    placeholder="Nama Lengkap Penerima" type="text"
                                                                    name="dept2" id="dept2"
                                                                    onkeyup="this.value = this.value.toUpperCase()">
                                                                <span class="input-group-addon"><i
                                                                        class="fa fa-check"></i></span>
                                                        ...
                                                        <div class="col-md-5">
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><i
                                                                        class="fa fa-building fa-fw"></i></span>
                                                                <input class="form-control" placeholder="Dept / Bag."
                                                                    type="text" name="penerima" id="penerima"
                                                                    onkeyup="this.value = this.value.toUpperCase()">
                                                                <span class="input-group-addon"><i
                                                                        class="fa fa-check"></i></span>
                                                            </div>
                                                    ...
                                                    <div class="form-group has-warning">
                                                        ...
                                                        <div class="col-md-9">
                                                            <div class="input-group">
                                                                ...
                                                                <textarea class="form-control" cols="20" rows="3" maxlength="150" placeholder="Alamat lengkap tujuan"
                                                                    name="alamat2" id="alamat"></textarea>
                                                                <span class="input-group-addon"><i
                                                                        class="glyphicon glyphicon-edit"></i></span>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group has-warning">
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><i
                                                                        class="fa fa-map-marker fa-fw"></i></span>
                                                                <select class="form-control" name="prov2"
                                                                    id="prov2">
                                                                    <option value="" selected="selected">Pilih
                                                                        Provinsi</option>
                                                                    <?php
                                                        ...
                                                        <div class="col-md-3" id="ckabupaten2">
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-addon"><i
                                                                        class="fa fa-map-marker fa-fw"></i></span>
                                                                <select class="form-control" name="kab2"
                                                                    id="kab2">
                                                                    <option value="" selected="selected">Pilih
                                                                        Kabupaten
                                                                    </option>
                                                        ...
                                                        <div class="col-md-3" id="ckecamatan2">
                                                            <div class="input-group">
                                                                ...
                                                                <span class="input-group-addon"><i
                                                                        class="fa fa-map-marker fa-fw"></i></span>
                                                                <select class="form-control" name="kec2"
                                                                    id="kec2">
                                                                    <option value="" selected="selected">Pilih
                                                                        Kecamatan
                                                                    </option>
                                                        ...
                                                        <div class="col-md-3">
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><i
                                                                        class="fa fa-phone fa-fw"></i></span>
                                                                <input class="form-control"
                                                                    placeholder="Telp/HP Tujuan" type="tel"
                                                                    name="telp2" id="telp2">
                                                                <span class="input-group-addon"><i
                                                                        class="fa fa-check"></i></span>
                                                            </div>
                                            ...
                                            <div class="tab-pane " id="tab3">
                                                <br>
                                                <h3><strong>Step 3</strong> - Data Barang</h3>
                                                <div class="step-content">
                                                    <div class="form-group has-warning">
                                                        ...
                                                        <div class="col-md-4">
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><i
                                                                        class="fa fa fa-qrcode "
                                                                        style="color:red"></i></span>
                                                                <input class="form-control"
                                                                    placeholder="Resi (CGK9999999)" readonly
                                                                    type="text" name="resi" id="resi"
                                                                    data-mask-placeholder= "X"
                                                                    style="FONT-SIZE: x-large;" background: "top;">
                                                                <span class="input-group-addon"><i
                                                                        class="fa fa-check"></i></span>
                                                            </div>
                                                    ...
                                                    <div class="form-group has-warning">
                                                        <label class="col-md-2 control-label">Keterangan Isi
                                                            Paket</label>
                                                        <div class="col-md-4">
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><i
                                                                        class="fa fa-cube fa-fw"></i></span>
                                                                <input class="form-control"
                                                                    placeholder="Keterangan isi paket" type="text"
                                                    ...
                                                    <div class="form-group has-warning koli-item">
                                                        <div class="row"
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"><i
                                                                            class="fa fa-cube fa-fw"></i></i></span>
                                                                    <input class="form-control first-input"
                                                                        placeholder="P" type="number" min="1"
                                                                        max="1200" name="p" id="p"
                                                                        style="width:152%;"
                                                                        onkeyup="hitung_volume();">
                                                                    <span class="input-group-addon "><i
                                                                            class="fa fa-long-arrow-right fa-fw"
                                                                            style="display: none"></i></span>
                                                                    <input class="form-control first-input"
                                                                        placeholder="L" type="number" min="1"
                                                                        max="250" name="l" id="l"
                                                                        style="width:155%;"
                                                                        onkeyup="hitung_volume();">
                                                                    <span class="input-group-addon"><i
                                                                            class="fa fa-long-arrow-up fa-fw"
                                                                            style="display: none"></i></span>
                                                                    <input class="form-control first-input"
                                                                        placeholder="T" type="number" min="1"
                                                                        max="300"name="t" id="t"
                                                                        style="width:155%;"
                                                                        onkeyup="hitung_volume();">
                                                                    <span class="input-group-addon"><i
                                                                            ...
                                                                            style="display: none"></i></span>
                                                                    <input class="form-control first-input"
                                                                        placeholder="Volume" type="text"
                                                                        name="volx" style="width:100%;"
                                                                        id="vol0"
                                                            ...
                                                            <div class="col-md-4 col-sm-8">
                                                                <div class="input-group">
                                                                    <input class="form-control first-input"
                                                                        placeholder="Berat" type="number"
                                                                        name="beratx" id="berat0"
                                                                        onkeyup="updateTotal()"
                                                                        onkeypress="return isNumberKey(event)"
                                                                        style="width:169%; margin-right: -100px;">
                                                                    <span class="input-group-addon">kg</span>
                                                                    <input class="form-control first-input"
                                                                        placeholder="koli" type="number"
                                                                        id="koli0" name="koli0"
                                                                        onkeyup="updateTotal()" value="1"
                                                                        style="width:184%; margin-right: -100px;">
                                                                    <span class="input-group-addon">Koli</span>
                                                                    <input class="form-control first-input"
                                                                        placeholder="Packing" type="text"
                                                                        name="note0" id="note0"
                                                                        onkeyup="this.value = this.value.toUpperCase()">
                                                                </div>
                                                            ...
                                                            <div class="col-md-1 ">
                                                                ...
                                                                <button type="button" name="add_koli"
                                                                    class="btn btn-success" id="add_koli"><i
                                                                        class="fa fa-plus"></i></button>
                                                            </div>
                                                        </div>
                                                        <input id="iKoli" value="1" hidden>

                                                        <div id="col_koli" class="row margin-top-10"
                                                            style="padding-left:13px; padding-right:14px">
                                                    ...
                                                    <div class="form-group has-warning">
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><i
                                                                        class="fa fa-cube fa-fw"></i></span>
                                                                <input class="form-control" placeholder="Volume"
                                                                    type="text" name="vol" id="vol"
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="input-group">
                                                                ...
                                                                <input class="form-control" placeholder="Berat (kg)"
                                                        ...
                                                        <div class="col-md-2">
                                                            <div class="input-group">
                                                                <span class="input-group-addon"><i
                                                                        class="fa fa-cubes fa-fw"></i></span>
                                                                <input class="form-control" placeholder="Koli (Pcs)"
                                                                    type="text" name="koli" id="koli"
                                                                    onkeypress="return isNumberKey(event)" readonly>
                                                    ...
                                                    <span class="hidden-xs">
                                                        <div class="form-group has-warning " style="margin-top:50px;">
                                                            <label class="col-md-2 control-label">Tarif Tujuan</label>
                                                            <div class="col-md-3">
                                                                <div class="input-group">
                                                                    <span class="input-group-addon"><i
                            ...
                            <table id="dt_basic" class="table table-striped table-bordered table-hover"
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th data-class="phone"style="width:80px;"><i
                                                class="fa fa-fw fa-calendar text-muted hidden-md hidden-sm hidden-xs"></i>Tanggal
                                        </th>
                                        <th data-class="expand"style="width:70px;"><i
                                                class="fa fa fa-barcode text-muted hidden-md hidden-sm hidden-xs"
                                                style="color:red"></i> Resi</th>
                                        <th data-hide="phone"style="width:350px;"><i
                                                class="fa fa-fw fa-umbrella text-muted hidden-md hidden-sm hidden-xs"></i>Service
                                        </th>
                                        ...
                                        <th data-hide="phone"style="max-width:580px;"><i
                                        ...
                                        <th data-hide="phone,tablet" style="width:150px"><i
                        ...
                        <div class="form-group has-success">
                            ...
                            <div class="col-md-2">
                                <button type="button" id="btnCari" onclick="cari()" class="btn btn-primary"
                                    style="margin-top: -6px;margin-left: -11px;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body form" style="margin-bottom: 50px;">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <table id="datatable_pengirim"
                        class="table table-striped table-bordered table-hover dataTable no-footer has-columns-hidden"
                        width="100%" role="grid" aria-describedby="dt_basic_info" style="width: 100%;">
                        <thead>
                            <tr>
                                <th data-hide="phone">No.</th>
                                <th data-class="expand">Bept / Bag</th>
                                <th data-class="phone">Pengirim</th>
                                <th data-hide="phone">Alamat</th>
                                <th data-hide="phone">Kab</th>
                                <th data-hide="phone,tablet" style="width:50px;">Act</th>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body form" style="margin-bottom: 50px;">
                <form action="#" id="form" class="form-horizontal">
                    ...
                    <table id="datatable_penerima"
                        class="table table-striped table-bordered table-hover dataTable no-footer has-columns-hidden"
                        width="100%" role="grid" aria-describedby="dt_basic_info" style="width: 100%;">
                        <thead>
                            <tr>
                                <th data-hide="phone">No.</th>
                                <th data-class="expand">Dept / Bag</th>
                                <th data-class="phone">Penerima</th>
                                <th data-hide="phone">Alamat</th>
                                <th data-hide="phone">Kab</th>
                                <th data-hide="phone">Tlp</th>
                                <th data-hide="phone,tablet" style="width:50px;">Act</th>
                            </tr>
                        </thead>
                    </table>
...
<script type="text/javascript">
    ...
    const Item = ({
        ...
        <div class="koli-item" id="koli-item-${id}">
			...
			<div class="col-md-4 col-sm-8">
				<div class="input-group">
					<input class="form-control iBerat" readonly placeholder="Berat" type="number" name="berats[]" id="berat${id}" value="${berat}" onkeyup="updateTotal()" onkeypress="return isNumberKey(event)" style="width:169%; margin-right: -96px;" required>
					<span class="input-group-addon"></span>
					<input class="form-control iKoli" readonly placeholder="koli"  type="number" onkeyup="updateTotal()" name="kolis[]" value="${kolix}" style="width:184%; margin-right: -95px;" >
					<span class="input-group-addon"></span>
...
<script type="text/javascript">
    ...
    function penolakan_asuransi(id) {
        window.open("<?php echo base_url(); ?>cadmin/laporan/cetak_penolakan_asuransi/" + id); // toso
    }
        ...
        table = $('#datatable_penerima').DataTable({
            ...
            "preDrawCallback": function() {
                ...
                if (!responsiveHelper_datatable_penerima) {
                    responsiveHelper_datatable_penerima = new ResponsiveDatatablesHelper($(
                        '#datatable_penerima'), breakpointDefinition);
                }
            },
            "rowCallback": function(nRow) {
