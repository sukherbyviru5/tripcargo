											...
											<div class="form-bootstrapWizard">
												<ul class="bootstrapWizard form-wizard">
													...
													<li data-target="#step2">
														<a href="#tab2" data-toggle="tab" > <span class="step">2</span> <span class="title">Data Penerima</span> </a>
													</li>
													<li data-target="#step3">
														<a href="#tab3" data-toggle="tab"> <span class="step">3</span> <span class="title">Data Barang</span> </a>
													</li>
										...
										return true;
														...
														<div class="form-group has-warning koli-item">
															...
															<div class="col-md-4 col-sm-8">
																<div class="input-group">
																	<input class="form-control first-input" placeholder="Berat" type="number" name="beratx" id="berat0" onkeyup="updateTotal()" onkeypress="return isNumberKey(event)" style="width:169%; margin-right: -100px;">
																	<span class="input-group-addon">kg</span>
																	<input class="form-control first-input" placeholder="koli" type="number" id="koli0" name="koli0" onkeyup="updateTotal()" value="1" style="width:184%; margin-right: -100px;" >
													...
													<span class="hidden-xs"><!--tidak tampil di hp-->
														...
														<div class="form-group has-warning">
															<label class="col-md-2 control-label">Asuransi dan biaya tambahan</label>
															<div class="col-md-3">
