...
/* Bloc Logo Lebel */
    ...
    //$pdf->SetLineWidth(0.01,0.01,0.02);
	//$pdf->Line(0.0,1.8,9.5,1.8); // batas heder logo yg di potong 1.8 cm
    ...
    //$pdf->SetDrawColor(188,188,188);
    //$pdf->SetLineWidth(0.01,0.01,0.02);
	//$pdf->Line(0.0,13.0,9.5,13.0); // batas leber kanan 9.5 cm
	 //garis vertikal
    //$pdf->SetDrawColor(188,188,188);
    //$pdf->SetLineWidth(0.01,0.01,0.02);
	//$pdf->Line(9.5, 0, 9.5, 13); // batas bawah lebel 13 cm
	//garis vertikal
    //$pdf->SetDrawColor(188,188,188);
    //$pdf->SetLineWidth(0.01,0.01,0.02);
	//$pdf->Line(0.1, 0, 0.1, 13); // batas bawah lebel 13 cm
	...
	$pdf->Cell(5,0.5,'Telp. **********'.substr($d->telp,0,4),'',0,'j',0); //.substr($d->telp,0,1)
	...
	//$pdf->Image($img, 1.2,11.2,7,1.6); //set margin kiri, atas, kanan, bawah 1cm, yata (BARCODE)
	//--------------------------
