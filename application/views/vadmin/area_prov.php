...
<div id="ribbon">
	<ol class="breadcrumb">
		<li>Home</li><li>Area Provinsi</li>
	</ol>
</div>	
<div id="content">
							...
							<form id="smart-form-register" class="form-horizontal" >
								...
								<fieldset>
									...
									<div class="form-group has-success">
										<label class="col-md-4 control-label">Kode Provinsi</label>
										<div class="col-md-8">
											<div class="input-group">
												<input type="hidden" name="id">
												<input class="form-control" type="text" name="prov_id" maxlength="2">
												<span class="input-group-addon"><i class="glyphicon glyphicon-barcode"></i></span>
											</div>
											<span class="help-block"><i class="fa fa-warning"></i> Number 2 digit</span>
										</div>
									</div>
									<div class="form-group has-success">
										<label class="col-md-4 control-label">Are Provinsi</label>
										
										<div class="col-md-8">
											<div class="input-group">
												<input class="form-control" type="text" name="prov" maxlength="30">
			...
			<article class="col-sm-12 col-md-12 col-lg-8">
				...
				<div class="jarviswidget" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false">
					...
					<header>
						...
						<h2>Daftar Area Provinsi (Pengiriman) <span id="loading2"></span></h2>
						...
						<table id="table" class="table table-striped table-bordered table-hover" width="100%">
								<thead>			                
									<tr>
										...
										<th data-class="phone" ><i class="fa fa-fw fa-tag text-muted hidden-md hidden-sm hidden-xs"></i> Provinsi</th>
...
// DO NOT REMOVE : GLOBAL FUNCTIONS!
	...
	function edit(id)
	{
		...
		$.ajax({
			url : "<?php echo base_url().'cadmin/home/area_prov_edit';?>/"+id,
			type: "GET",
			dataType: "JSON",
			success: function(data)
			{
				...
				$('[name="id"]').val(data.prov_id);
				$('[name="prov"]').val(data.prov);
				$('[name="prov_id"').attr('disabled',true);			
	...
	function hapus(id) {
			...
			buttons : [{
				...
				click : function() {
					...
					$.ajax({
							type: "POST",
							url : "<?php echo base_url().'cadmin/home/area_prov_hapus';?>/"+id,
							data: kode,
							// dataType: "JSON",
							beforeSend: function(){
							   // $("#loaderDiv").show();
	...
	*/
	...
	function save()
	{
		...
		var url;
			...
			url = "<?php echo base_url().'cadmin/home/area_prov_add';?>";
...
$(document).ready(function() {
	...
	table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('cadmin/home/area_prov_ajax_list')?>",
            "type": "POST"
        },
