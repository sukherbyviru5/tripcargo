...
<head>
    ...
    <link rel="apple-touch-startup-image" href="<?php echo base_url('assets/img/splash/ipad-landscape.png'); ?>"
        media="screen and (min-device-width: 481px) and (max-device-width: 1024px) and (orientation:landscape)">
    <link rel="apple-touch-startup-image" href="<?php echo base_url('assets/img/splash/ipad-portrait.png'); ?>"
    ...
    <script>
        if (!window.jQuery) {
            document.write('<script src="<?php echo base_url('assets/js/libs/jquery-2.1.1.min.js'); ?>">
    </script>');
    }
    </script>
    ...
    <script>
        if (!window.jQuery.ui) {
            document.write('<script src="<?php echo base_url('assets/js/libs/jquery-ui-1.10.3.min.js'); ?>">
    </script>');
    }
    </script>
</head>
            ...
            <ul id="mobile-profile-img" class="header-dropdown-list hidden-xs padding-top-10 padding-bottom-5">
                <li>
                    <div class="dropdown-toggle no-margin userdropdown" data-toggle="dropdown" aria-expanded="true">
                        <img src="<?php echo base_url('assets/upload/' . ($record[0]->foto ?? 'avatars/7.png')); ?>" width="28px" class="img-circle img-responsive"
                            alt="<?php echo $this->session->userdata('nama_pengguna') ?? 'User'; ?>">
                        <span style="font-size: 0.7em; font-weight: bold;"><?php echo $this->session->userdata('nama_pengguna') ?? 'Guest'; ?></span>
                    </div>
                    <ul class="dropdown-menu pull-right">
                        <li><a href="<?php echo base_url('cadmin/home/profile'); ?>" class="padding-10"><i class="fa fa-user"></i> Profile</a>
                        </li>
                        <li class="divider"></li>
                        <li><a href="javascript:void(0);" class="padding-10" data-action="toggleShortcut"><i
                                    class="fa fa-arrow-down"></i> Shortcut</a></li>
                        <li class="divider"></li>
                        <li><a href="javascript:void(0);" class="padding-10" data-action="launchFullscreen"><i
                                    class="fa fa-arrows-alt"></i> Full Screen</a></li>
                        <li class="divider"></li>
                        <li><a href="<?php echo base_url('cadmin/home/logout'); ?>" class="padding-10" data-action="userLogout"><i
                                    class="fa fa-sign-out fa-lg"></i> <strong>Logout</strong></a></li>
                    </ul>
                </li>
            </ul>
            <!-- Search Form -->
    ...
    <aside id="left-panel">
        ...
        <nav>
            ...
            <ul>
                ...
                <!-- Entri Shipment -->
                <li>
                    <a href="#" title="Entri Shipment"><i class="fa fa-lg fa-fw fa-cube"></i> <span
                            class="menu-item-parent">Entri Shipment</span></a>
                    <ul>
                ...
                <!-- Laporan -->
                <li>
                    <a href="#" title="Laporan"><i class="fa fa-lg fa-fw fa-print"></i> <span
                            class="menu-item-parent">Laporan</span></a>
                    <ul>
                ...
                <!-- Asuransi -->
                <li>
                    <a href="#" title="Asuransi"><i class="fa fa-lg fa-fw fa-newspaper-o"></i> <span
                            class="menu-item-parent">Asuransi</span></a>
                    <ul>
                        <li>
                            <a href="#" title="Formulir Asuransi">Formulir Asuransi</a>
                            <ul>
                                <li><a target="_blank" href="<?php echo base_url('assets/atropos/images/SPPA_MARINE_CARGO.doc'); ?>"
                                        title="Formulir Asuransi doc">doc</a></li>
                                <li><a target="_blank" href="<?php echo base_url('assets/atropos/images/SPPA_MARINE_CARGO.pdf'); ?>"
                                        title="Formulir Asuransi pdf">pdf</a></li>
                            </ul>
                        </li>
                    </ul>
                </li>
                <!-- QRIS -->
                <li>
                    <a href="#" title="QRIS"><i class="fa fa-lg fa-fw fa-qrcode"></i> <span
                            class="menu-item-parent">QRIS</span></a>
                    <ul>
                        <li><a target="_blank" href="<?php echo base_url('assets/atropos/images/ID2025372662440.jpeg'); ?>" title="QRIS Trip Cargo"><img
                                    alt="QRIS logo"
                                    src="//upload.wikimedia.org/wikipedia/commons/thumb/e/e1/QRIS_logo.svg/150px-QRIS_logo.svg.png"
                                    decoding="async" width="auto" height="20"></a></li>
                        <li><a target="_blank"
                                href="https://qr.klikbca.com/QRMerchantService/v2.10/home?mid=002804257"
                                title="Laporan QRIS">Laporan QRIS Trip Cargo</a></li>
                    </ul>
                </li>
                <!-- Tarif -->
                <li>
                    ...
                    <ul>
                        ...
                        <li><a target="_blank" href="https://tripcargo.test/web/Tarif_Kargo_Hemat"
                ...
                <!-- Pajak -->
                <li>
                    <a href="#" title="Pajak"><i class="fa fa-lg fa-fw fa-gavel"></i> <span
                            class="menu-item-parent">Pajak</span></a>
                    <ul>
                        <li><a target="_blank" href="https://ui-login.oss.go.id/login" title="Login OSS"><img
                                    style="height: 23px; width: 60px;" alt="OSS Logo"
                                    src="https://perizinan.oss.go.id/media/logos/logo-bkpm-new/OSS%20LOGO%20NEW%202024%20ID.svg"></a>
                        </li>
                        <li><a target="_blank" href="https://djponline.pajak.go.id/account/login"
                                title="Login DJP"><img style="height: 23px; width: 60px;" alt="DJP Logo"
                                    src="https://static.pajak.go.id/assets/media/logos/Logo DJP.png"></a></li>
                    </ul>
                </li>
                <!-- Search -->
                <li>
                    <a href="#" title="Search"><i class="fa fa-search"></i> <span
                            class="menu-item-parent">Search</span></a>
                    <ul>
                ...
                <!-- Settings -->
                <li>
                    <a href="#" title="Settings"><i class="fa fa-cog"></i> <span
                            class="menu-item-parent">Settings</span></a>
                    <ul>
                        <li class="<?php echo $this->app_model->status_menu($akt, 'introduction'); ?>">
                            <a href="<?php echo base_url('cadmin/home/introduction'); ?>" title="Introduction & Visi Misi">Introduction & Visi
                                Misi</a>
                        </li>
                        <li class="<?php echo $this->app_model->status_menu($akt, 'customer'); ?>">
                            <a href="<?php echo base_url('cadmin/home/customer'); ?>" title="Custommer">Custommer</a>
                        </li>
                ...
                <!-- Member -->
                <li>
                    <a href="#" title="Member"><i class="glyphicon glyphicon-user"></i> <span
                            class="menu-item-parent">Member</span></a>
                    <ul>
                        <li class="<?php echo $this->app_model->status_menu($akt, 'users'); ?>">
                ...
                <!-- Update -->
                <li>
                    <a href="#" title="Update"><i class="fa fa-lg fa-fw fa-paper-plane"></i> <span
                            class="menu-item-parent">Update</span></a>
                    <ul>
                        <li class="<?php echo $this->app_model->status_menu($akt, 'updatecargo'); ?>">
                            <a href="<?php echo base_url('cadmin/home/updatecargo'); ?>" title="Update Posisi Cargo">Update Posisi Cargo</a>
                        </li>
                ...
                <!-- WA -->
                <li>
                    <a href="#" title="WA"><i class="fa fa-whatsapp"></i> <span
                            class="menu-item-parent">WA</span></a>
                    <ul>
                        <li class="<?php echo $this->app_model->status_menu($akt, 'lpengiriman'); ?>">
                            <a target="_blank" href="https://api.whatsapp.com/send?phone=62881080899678"
                                title="Hubungi Admin">Hubungi Admin</a>
                        </li>
                    </ul>
                </li>
                <?php } ?>
            ...
            <section id="widget-grid" class="">
                <div class="row">
                    <article class="col-sm-12 col-md-12 col-lg-12">
                        <div class="jarviswidget" id="wid-id-service" data-widget-editbutton="false"
                            ...
                            <header>
                                ...
                                <div class="widget-toolbar">
                                    <button class="btn btn-primary" onclick="addService()">
                                        <i class="fa fa-plus-circle"></i> Tambah Service
                                    </button>
                                </div>
                            </header>
                            <div class="p-5" style="padding: 30px !important;">
                                ...
                                <div class="widget-body no-padding">
                                    <table id="serviceTable" class="table table-striped table-bordered table-hover"
                                        ...
                                        <thead>
                                            <tr>
                                                <th data-class="expand" width="5%">No</th>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="serviceModalLabel">Form Service</h4>
                    </div>
                    <div class="modal-body">
                        <form id="serviceForm" class="form-horizontal">
                            ...
                            <div class="form-group">
                                <label class="col-md-3 control-label">Nama Service</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="title" id="serviceTitle"
                                        placeholder="Cth: Pengiriman Darat" required>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9">
                                    <textarea class="form-control" name="description" id="serviceDescription" rows="4"
                                        placeholder="Jelaskan tentang service ini"></textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-3 control-label">Kelas Ikon</label>
                                <div class="col-md-9">
                                    <input type="text" class="form-control" name="icon" id="serviceIcon"
                                        placeholder="Cth: fa-truck" required>
                                    <small class="help-block">Masukkan kelas ikon dari <a
                                            href="https://fontawesome.com/v4.7.0/icons/" target="_blank">Font Awesome
                                            4.7</a>. Contoh: <strong>fa-truck</strong>, <strong>fa-plane</strong>,
                                        <strong>fa-ship</strong>.</small>
                                </div>
                            </div>
                        </form>
                    </div>
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="btnSave" onclick="saveService()">
        ...
        <script>
            ...
            $(document).ready(function() {
                ...
                table = $('#serviceTable').DataTable({
                    ...
                    "serverSide": true,
                    "ajax": {
                        "url": "<?php echo base_url('cadmin/home/get_services_ajax'); ?>",
                        "type": "POST"
                    },
                    "columns": [{
                            "data": "no",
            ...
            function editService(id) {
                $('#serviceForm')[0].reset();
                $.ajax({
                    url: "<?php echo base_url('cadmin/home/get_service_by_id/'); ?>" + id,
                    type: "GET",
                    dataType: "JSON",
            ...
            function saveService() {
                ...
                if (id) {
                    url = "<?php echo base_url('cadmin/home/update_service'); ?>";
                } else {
                    url = "<?php echo base_url('cadmin/home/store_service'); ?>";
                }
            ...
            function deleteService(id) {
                // Gunakan konfirmasi dari SmartAdmin jika ada, atau confirm() biasa
                if (confirm('Apakah Anda yakin ingin menghapus data ini?')) {
                    $.ajax({
                        url: "<?php echo base_url('cadmin/home/delete_service/'); ?>" + id,
                        type: "POST",
                        dataType: "JSON",
                        success: function(data) {
                            reload_table();
                            $.smallBox({
                                title: "Dihapus!",
                                content: "<i class='fa fa-trash-o'></i> <i>Data service berhasil dihapus.</i>",
                                color: "#659265",
                                timeout: 4000
                            });
                        },
