                    ...
                    <table id="datatable_pengirim" class="table table-striped table-bordered table-hover" width="100%">
						<thead>			                
							<tr>
								...
								<th data-class="phone"><i class="fa fa-fw fa-tags text-muted hidden-md hidden-sm hidden-xs"></i> Pengirim</th>
								<th data-class="expand"><i class="fa fa-fw fa-tag text-muted hidden-md hidden-sm hidden-xs"></i>Nama</th>
