							...
							<form id="smart-form-register" class="form-horizontal" >
								...
								<fieldset>
									...
									<div class="form-group has-success col-md-12">
										...
										<div class="col-md-3">
											<div class="input-group">
												...
												<input class="datepicker form-control"placeholder="Tanggal Dikirim" type="text" name="tgl" maxlength="10" data-dateformat="dd-mm-yy">
										...
										<div class="col-md-2 control-label">
											<div class="input-group">
												<input class="form-control" placeholder="Driver / No. Mobil" type="text" name="driver" maxlength="60" onkeyup="this.value = this.value.toUpperCase()">
												<span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></i></span>
											</div>
										</div>
										<div class="col-md-2 control-label">
											<div class="input-group">
												<input class="form-control" placeholder="HP / WA Driver" type="tel" name="tlpdriver" maxlength="14" >
												<span class="input-group-addon"><i class="glyphicon glyphicon-phone-alt"></i></i></span>
											</div>
										</div>
									</div>
									...
									<div class="form-group has-success col-md-12">
										...
										<div class="col-md-4">
											<div class="input-group">
												<input class="form-control" placeholder="Drop Point / Cab / Gateway / Kode Daerah" type="text" name="tujuan" maxlength="60" onkeyup="this.value = this.value.toUpperCase()">
												<span class="input-group-addon"><i class="glyphicon glyphicon-map-marker"></i></span>
											</div>
										</div>
										
									<!--div class="form-group has-success">
										<label class="col-md-2 control-label">Sortir</label-->
										<div class="col-md-2">
											<div class="input-group">
												<input class="form-control" placeholder="Sortir / Keluar / Masuk" readonly type="text" name="sortir" value="SORTIR" maxlength="10" onkeyup="this.value = this.value.toUpperCase()">
									...
									<!--div class="col-md-4">
										...
										<div class="input-group">
										<input type="radio" name="Sortir" value="Sortir">
										Sortir
										&emsp;
										<input type="radio" name="Sortir" value="keluar">
										Keluar
										&emsp;
										<input type="radio" name="Sortir" value="Masuk">
										Masuk
										</div>					
									</div---> 
									...
									<div class="form-group has-success col-md-12">
										<label class="col-md-2 control-label">Remake</label>
										<div class="col-md-4">
											<div class="input-group">
												<textarea class="form-control" placeholder="catatan tambahan" type="text" cols="15" rows="2" maxlength="100" name="remake" ></textarea>
								...
								<thead>			                
									<tr>
										...
										<th data-hide="phone" ><i class="fa fa-tag fa-lg text-muted hidden-md hidden-sm hidden-xs"></i> Alamat</th>
