...
<div id="content">
	...
	<section id="widget-grid" class="">
		...
		<div class="row">
			      ...
			      <div class="responsive" style="margin-bottom:3rem;"  class="style3"><class="table-bordered">
			          
                        <td style="background-color: #3c878a;">
			...
			<article class="col-sm-8 col-md-8 col-lg-12">
				...
				<div class="jarviswidget" id="wid-id-10"  class="button-icon jarviswidget-toggle-btn" rel="tooltip" title="" data-placement="bottom"  data-widget-fullscreenbutton="false" style="display: block; ">
						...
						<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
								<thead>			                
									<tr>
										...
										<!---<th data-hide="expand" style="width:120px;"><i class="fa fa-calendar text-muted hidden-md hidden-sm hidden-xs"></i> Tgl</th> --->
										<th data-class="phone" style="width:180px;"><i class="fa fa-fw fa-tag text-muted hidden-md hidden-sm hidden-xs"></i>Status</th>
										<!---<th data-hide="phone" ><i class="fa fa-fw fa-tag text-muted hidden-md hidden-sm hidden-xs"></i> Ket/Catan</th> --->
										<!---<th data-hide="phone" ><i class="fa fa-fw fa-tag text-muted hidden-md hidden-sm hidden-xs"></i> Diterima</th>--->
										<!--- <th data-class="phone" ><i class="fa fa-map-o text-muted hidden-md hidden-sm hidden-xs"></i> Lokasi</th>--->
	...
	<!-- Awal -->
		...
		<!-- NEW WIDGET START -->
			<article class="col-sm-8 col-md-8 col-lg-12">
				...
				<!-- Widget ID (each widget will need unique ID)-->
				<div class="jarviswidget" id="wid-id-10"  class="button-icon jarviswidget-toggle-btn" rel="tooltip" title="" data-placement="bottom" style="display: block; ">
					<!-- widget options:
					usage: <div class="jarviswidget" id="wid-id-0" data-widget-editbutton="false">
