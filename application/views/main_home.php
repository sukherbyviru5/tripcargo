...
<div id="wrapper">
    ...
    <div class="fullwidthbanner-container roundedcorners" style="margin-top:-30px; overflow: visible;">
        ...
        data-start="500"
        style="z-index:-3"
        data-easing="easeOutBack">EXPEDISI ANTAR PULAU
       </div-->
        ...
        style="z-index: 2; color:#F1C40F; font-style: italic; font-family: sans-serif;"> EXPEDISI SUMATERA
       </div--->
                    <!-- LAYER NR. 2 -->
        ...
        data-endeasing="Power4.easeIn"
        data-captionhidden="off"
        style="z-index: 2; color:#FDFEFE; font-size: 50px; font-style: italic; font-family: sans-serif;"> #karung balap
       </div--->
                    <!-- LAYER NR. 3 -->
    ...
    <div style='width:100%;background:#fff;height:100%;'>
        <div style='width:100%;max-width:100%;margin:0 auto;padding: 0px 0px;'>
            <!-- NEW WIDGET START -->
            <article class="">
     ...
     -->
                    ...
                    <div>
                        ...
                        <div class="widget-body"
                            style='position:relative;width:100%;max-width:100%;margin:0;height:auto;background:#101E6F'>
                            <div class='mencong'>
                                <div class='mencongkiri'>
                                    <div class="container">
                                ...
                                <div style='color:#fff;font-weight:bold;margin-left:-12px;'>
                                ...
                                <div class='mencongkanan'>
                                    <h3 style='margin:0;color:#fff;'><b>CEK TARIF</b></h3>
                                    Cek ongkos kirim dengan mudah dan cepat
                                    <br>
                                    <br>
                                    <a href="<?php echo base_url(); ?>web/cektarif" class='button1'>CEK ONGKIR</a>
                                </div>
                            </div>
                        </div>
                        <!-- end widget content -->
     ...
     -->
                    ...
                    <div>
                        ...
                        <!-- widget content -->
                        <div class="tp-bannertimer" style="margin-left: -15px;"></div>
                        <div class='btracking'>
                            <div class="widget-body"
                                style=';width:98%;max-width:100%;margin:0 auto;float:center;position:relative;overflow: hidden;'>
                                <div id="info"
                                    style='float:center;
   ...
   <style>
    /* =================================================================
      STYLES GLOBALS & DEFINISI VARIABEL
      ================================================================= */
    :root {
        --color-dark-blue: #101E6F;
        --color-accent-red: #cc3d3d;
        --color-light-bg: #F0F4FF; /* Latar belakang biru sangat muda */
        --color-grey-bg: #F8F9FA;  /* Latar belakang abu-abu */
        --color-white: #FFFFFF;
        --color-heading: #1A253C;
        --color-text: #555E6D;
        --border-radius: 12px;
    }
    ...
    .hero-image-stack .img-service:hover {
        transform: translateY(-10px) rotate(3deg) !important;
        z-index: 10;
    }

    .hero-image-stack .img-1 {
        position: absolute;
        top: 0;
        left: 0;
    ...
    /* =================================================================
      2. SERVICES SECTION (BAGIAN LAYANAN)
      ================================================================= */
    .services-section {
        padding: 80px 0;
    ...
    /* =================================================================
      3. CUSTOMER SECTION (BAGIAN PELANGGAN)
      ================================================================= */
    .customer-section {
        padding: 80px 0;
        background-color: var(--color-grey-bg);
...
<section class="hero">
    <div class="container">
       <div class="hero-content">
            <div class="section-pretitle">LAYANAN KAMI</div>
            <h1>Jasa Pengiriman Terpercaya</h1>
            <p style="font-size: medium;">
                Kami menyediakan layanan pengiriman yang andal dan profesional, menjangkau seluruh pelosok Indonesia. Komitmen kami adalah memastikan setiap paket tiba tepat waktu, dalam kondisi aman, dan dengan pelayanan terbaik.
            </p>
        </div>

        <div class="hero-image-stack">
            <img class="img-service img-1" src="<?php echo base_url(); ?>assets/images/IMG-20250807-WA0023.jpg" alt="Layanan Cargo Profesional">
            <img class="img-service img-2" src="<?php echo base_url(); ?>assets/images/IMG-20250807-WA0021.jpg" alt="Armada Trucking Modern">
            <img class="img-service img-3" src="<?php echo base_url(); ?>assets/images/IMG-20250807-WA0022.jpg" alt="Proses Pindahan Aman">
        </div>
    </div>
</section>
...
<section class="services-section">
    <div class="container">
        <div class="section-title">
            <div class="section-pretitle">SERVICE KAMI</div>
            <h2>PENGIRIMAN CEPAT, CARGO & MOVING SERVICES</h2>
            <p>Trip Cargo memberikan layanan pengiriman barang ke seluruh wilayah Indonesia yang amanah, aman, dan dapat diakses secara real-time dengan harga yang bersaing.</p>
        </div>
        <div class="feature-list">
            <div class="feature-item">
                <div class="feature-icon"><i class="fa fa-cube"></i></div>
                <div class="feature-content">
                    <h3>Jasa Pengiriman Barang</h3>
                    <p>Trip Cargo melayani pengiriman barang (distribusi barang) paket ringan, sedang, atau alat berat ke seluruh Indonesia, dengan tarif murah, amanah, dan barang terjamin aman dengan asuransi serta dikerjakan oleh sumber daya manusia yang profesional. Pengantaran door-to-door atau port-to-port melalui darat, laut, dan udara.</p>
                </div>
            </div>
            <div class="feature-item">
                ...
                <div class="feature-content">
                    <h3>Trucking</h3>
                    <p>Armada truk kami mengangkut barang-barang atau pengiriman paket sedang hingga besar untuk memudahkan bongkar muat dengan kapasitas banyak. Kami siap kirim antar pulau, menyesuaikan keselamatan dan keamanan barang dengan kapasitas truk.</p>
                </div>
            </div>
            <div class="feature-item">
                ...
                <div class="feature-content">
                    <h3>Jasa Pindahan</h3>
                    <p>Kami ahli dalam relocation dan moving service seperti pindahan kantor, rumah, atau kost. Kami menangani mulai dari packing, pengantaran, hingga penempatan barang, termasuk barang pabrik.</p>
                </div>
            </div>
            <div class="feature-item">
                <div class="feature-icon"><i class="fa fa-car"></i></div>
                <div class="feature-content">
                    <h3>Sewa Mobil Harga Murah 200rb/hari</h3>
                    <p>Trip Cargo menyediakan rental mobil untuk pengangkutan barang industri, home industri, atau produk UMKM dengan sistem sewa harian, bulanan, atau kontrak. Armada baru dengan jenis niaga.</p>
                </div>
            </div>
        </div>
    </div>
...
<section class="customer-section">
    <div class="container">
        <div class="section-title">
            <h3 class="section-pretitle">PELANGGAN KAMI</h3>
    ...
    <!-- SERVICES -->
    <section class="container margin-top100" style='display:none;'>

        <amp-auto-ads type="adsense" data-ad-client="ca-pub-2590339526281789">
        </amp-auto-ads>

        <script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
        <ins class="adsbygoogle" style="display:block; text-align:center;" data-ad-layout="in-article"
            data-ad-format="fluid" data-ad-client="ca-pub-2590339526281789" data-ad-slot="7208102495"></ins>
        <script>
