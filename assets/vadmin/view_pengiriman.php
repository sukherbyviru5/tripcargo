				...
				<div class="col-sm-8">
					...
					<!-- widget content -->
						...
						<div id="smart-form-register" class="smart-form" novalidate="novalidate">
								...
								<label>Pilih berdasarkan tanggal</label>
								</section>
								<section class="col-sm-3">
								...
								<section class="col-sm-3">
									...
									<input type="text" name="nama_pel" placeholder="Ketik/Cari Pengirim"  >
									</label>
									</label>
								</section>
            ...
            <div class="modal-body form">
                <form action="#" id="form" class="form-horizontal">
                    <table id="datatable_pengirim" class="table table-striped table-bordered table-hover" width="100%">
						<thead>			                
							<tr>
								<th data-class="expand"><i class="fa fa-square text-muted hidden-md hidden-sm hidden-xs"></i></th>
								<th data-hide="phone"><i class="fa fa-building fa-fw text-muted hidden-md hidden-sm hidden-xs"></i> Pengirim</th>
								<th data-class="expand" ><i class="fa fa-user fa-fw text-muted hidden-md hidden-sm hidden-xs"></i>Nama</th>
								<th data-hide="phone" ><i class="fa fa-map-o fa-fw text-muted hidden-md hidden-sm hidden-xs"></i> Alamat</th>
								<th data-hide="phone" ><i class="fa fa-map-marker fa-fw text-muted hidden-md hidden-sm hidden-xs"></i> Kota/Kab</th>
...
function cari() {
	...
	$.ajax({
			type: "POST",
			url : "<?php echo base_url().'cadmin/laporan/cetak_pengiriman';?>",
			data: id,
			beforeSend: function(){
			   // $("#loaderDiv").show();
			   loading.fadeIn();						
