					...
					<div>
						...
						<!-- widget content -->
							<div class="widget-body">
								...
								<div class="row">
									<form id="wizard-1"  class="form-horizontal" novalidate="novalidate">
														...
														<div class="form-group has-warning">
															...
															<div class="col-md-4">
																<div class="input-group">
																	...
																	<input class="form-control" placeholder="Nama Lengkap Pengirim" type="text" name="nama" id="nama">
															...
															<div class="col-md-3">
																<div class="input-group">
																	...
																	<input class="form-control" placeholder="Dept / Perusahaan" type="text" name="dept" id="dept">
																	<span class="input-group-addon"><i class="fa fa-check"></i></span>
																</div>
															</div>
														...
														<div class="form-group has-warning">
															...
															<div class="col-md-3">
																<div class="input-group">
																	...
																	<input class="form-control" placeholder="Telp/hp Pengirim" type="text" name="telp" id="telp">
																	<span class="input-group-addon"><i class="fa fa-check"></i></span>
																</div>
															...
															<div class="col-md-3">
																<div class="input-group">
																	...
																	<input class="form-control" placeholder="Email Pengirim" type="email" name="email" id="email">
																	<span class="input-group-addon"><i class="fa fa-check"></i></span>
																</div>
													...
													<div class="step-content">
														<div class="form-group has-warning">
															...
															<div class="col-md-4">
																<div class="input-group">
																	<span class="input-group-addon"><i class="fa fa-user fa-fw"></i></span>
																	<input class="form-control" placeholder="Nama Lengkap Penerima" type="text" name="penerima" id="penerima">
																	<span class="input-group-addon"><i class="fa fa-check"></i></span>
																</div>
															</div>
																<div class="col-md-3">
																<div class="input-group">
																	<span class="input-group-addon"><i class="fa fa-building fa-fw"></i></span>
																	<input class="form-control" placeholder="Dept / Bag." type="text" name="dept2" id="dept2">
																	<span class="input-group-addon"><i class="fa fa-check"></i></span>
																</div>
															</div>
														...
														<div class="form-group has-warning">
															...
															<div class="col-md-7">
																<div class="input-group">
																	<span class="input-group-addon"><i class="fa fa-map-o fa-fw"></i></span>
																	<input class="form-control" placeholder="Alamat Tujuan " type="text" name="alamat2" id="alamat">
																	<span class="input-group-addon"><i class="fa fa-check"></i></span>
																</div>
														...
														<div class="form-group has-warning">
															...
															<div class="col-md-3">
																<div class="input-group">
																	<span class="input-group-addon"><i class="fa fa-phone fa-fw"></i></span>
																	<input class="form-control" placeholder="Telp/HP Tujuan" type="text" name="telp2" id="telp2">
																	<span class="input-group-addon"><i class="fa fa-check"></i></span>
																</div>
														...
														<div class="form-group has-warning">
															...
															<div class="col-md-4">
																<div class="input-group">
																	...
																	<input class="form-control" placeholder="Resi (CGK-9999999)" type="text" name="resi" id="resi" data-mask="***-9999999" data-mask-placeholder= "X" >
																	<span class="input-group-addon"><i class="fa fa-check"></i></span>
																</div>
														...
														<div class="form-group has-warning">
															...
															<div class="col-md-4">
																<div class="input-group">
																	...
																	<input class="form-control" placeholder="Keterangan isi paket" type="text" name="deskripsi" id="deskripsi">
																	<span class="input-group-addon"><i class="fa fa-check"></i></span>
																</div>
									...
									function isNumberKey(evt)
									{
										...
										return true;
														...
														<div class="form-group has-warning koli-item">
															...
															<div class="col-md-4">
																<div class="input-group">
																	...
																	<input class="form-control" placeholder="P (cm)" type="text" min="1" max="420" name="p" id="p" style="width:55px;" onkeyup="hitung_volume();">
																	<span class="input-group-addon"><i class="fa fa-long-arrow-right fa-fw"></i></span>
																	<input class="form-control" placeholder="L (cm)" type="text" min="1" max="200" name="l" id="l" style="width:55px;" onkeyup="hitung_volume();">
																	<span class="input-group-addon"><i class="fa fa-long-arrow-up fa-fw"></i></span>
																	<input class="form-control" placeholder="T (cm)" type="text" min="1" max="170"name="t" id="t" style="auto;" onkeyup="hitung_volume();">
																	<span class="input-group-addon"><i class="fa fa-check"></i></span>
																</div>
															</div>
															<div class="col-md-5">
																<div class="input-group">
																	...
																	<input class="form-control iVol"  placeholder="Volume" type="text" name="volx" id="vol0" onkeypress="return isNumberKey(event)" readonly>
																	<span class="input-group-addon">cm<sup>3</sup></span>
																	
																	<input class="form-control iBerat" placeholder="Berat" type="text" name="beratx" id="berat0" onkeyup="updateBerat()" onkeypress="return isNumberKey(event)">
																	<span class="input-group-addon">kg</span>
																	
																	<input class="form-control iKoli" placeholder="koli" type="text" onkeyup="updateTotal()" value="1" >
														...
														<div class="form-group has-warning">
															<label class="col-md-2 control-label">Estimasi Harga/Kg</label>
															<div class="col-md-3">
																<div class="input-group">
																	<span class="input-group-addon"><i class="fa fa-money fa-fw"></i></span>
																	<input class="form-control" placeholder="Estimasi/kg" type="text" name="harga" id="harga" onblur="hitung_esti();" onkeypress="return isNumberKey(event)">
																	<span class="input-group-addon"><i class="fa fa-dollar"></i></span>
																</div>
															</div>
															<div class="col-md-1">
															<button type="button" id="cek_harga" name="cek_harga" class="btn btn-success" onclick="load_harga()"><i class="fa fa-search"></i>   Cek Harga </button>
															</div> 
														...
														<div class="form-group has-warning">
															...
															<div class="col-md-3">
																<div class="input-group">
																	<span class="input-group-addon"><i class="fa fa-money fa-fw"></i></span>
																	<input class="form-control" placeholder="Bayar Tujuan / DFOD / COD (Rp)" type="text" name="harga1" id="harga1" onblur="hitung();" onkeypress="return isNumberKey(event)">
																	<span class="input-group-addon"><i class="fa fa-dollar"></i></span>
																</div>
															</div>
															<div class="col-md-3">
																<div class="input-group">
																	<span class="input-group-addon"><i class="fa fa-money fa-fw"></i></span>
																	<input class="form-control" placeholder="Biaya Kirim Paket (Rp)" type="text" name="harga2" id="harga2" onblur="hitung();" onkeypress="return isNumberKey(event)">
																	<span class="input-group-addon"><i class="fa fa-dollar"></i></span>
																</div>
															</div>
															<div class="col-md-3">
																<div class="input-group">
																	<span class="input-group-addon"><i class="fa fa-money fa-fw"></i></span>
																	<input class="form-control" placeholder="Biaya Kirim Expres (Rp)" type="text" name="harga3" id="harga3" onblur="hitung();" onkeypress="return isNumberKey(event)">
																	<span class="input-group-addon"><i class="fa fa-dollar"></i></span>
																</div>
															</div>
														...
														<div class="form-group has-warning">
															...
															<div class="col-md-3">
																<div class="input-group">
																	<span class="input-group-addon"><i class="fa fa-money fa-fw"></i></span>
																	<input class="form-control" placeholder="Nilai Barang di Asuransikan (Rp)" type="text" name="harga6" id="harga6" onblur="hitung();" onkeypress="return isNumberKey(event)">
																	<span class="input-group-addon"><i class="fa fa-dollar"></i></span>
																</div>
															</div>
															<div class="col-md-3">
															...
															<div class="col-md-3">
																<div class="input-group">
																	<span class="input-group-addon"><i class="fa fa-money fa-fw"></i></span>
																	<input class="form-control" placeholder="Paking / Vendor / Lain-lain (Rp)" type="text" name="harga5" id="harga5" onblur="hitung();"  onkeypress="return isNumberKey(event)">
																	<span class="input-group-addon"><i class="fa fa-dollar"></i></span>
																</div>
															</div>
														</div>
															...
															<div class="col-md-3">
																<div class="input-group">
																	...
																	<input type="radio" name="metode" value="Payment">
																	 <a data-toggle="tooltip" title="Transaksi digital melalui kartu kredit, debit, transfer bank, mapun e-money"> Payment </a>
																	<input type="radio" name="metode" value="Kredit">
																	 Kredit
																	 <input type="radio" name="metode" value="DFOD">
																	 <a data-toggle="tooltip" title="Delivery Fee On Delivery"> DFOD </a>
																</div>
															</div>
															<div class="col-md-3">
																<div class="input-group">
																	<span class="input-group-addon"><i class="fa fa-comments fa-fw"></i></span>
																	<input class="form-control" placeholder="Catatan" type="text" name="catatan" id="Catatan tambahan">
			...
			<article class="col-sm-12 col-md-12 col-lg-12">
				...
				<div class="jarviswidget" id="wid-id-10" data-widget-colorbutton="false" data-widget-editbutton="false">
					...
					<header>
						...
						<h2>Daftar Cargo <span id="loading2"></span></h2>
						...
						<table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%" >
								<thead>			                
									<tr>
										...
										<th data-class="expand"style="width:90px;"><i class="fa fa fa-barcode text-muted hidden-md hidden-sm hidden-xs" style="color:red"></i>  Resi</th>
										<th data-hide="phone"style="width:60px;" ><i class="fa fa-fw fa-umbrella text-muted hidden-md hidden-sm hidden-xs"></i>Service</th>
										...
										<th data-hide="phone"style="width:100px;"><i class="fa fa-fw fa-archive text-muted hidden-md hidden-sm hidden-xs"></i> Isi Barang</th>
										<th data-hide="phone"><i class="fa fa-fw fa-building text-muted hidden-md hidden-sm hidden-xs"></i> Penerima</th>
										<th data-hide="phone"><i class="fa fa-fw fa-map text-muted hidden-md hidden-sm hidden-xs"></i> Alamat</th>
										<th data-hide="phone"><i class="fa fa-fw fa-users text-muted hidden-md hidden-sm hidden-xs"></i> User ID</th>
										
										<th data-hide="phone,tablet" style="width:14%"><i class="fa fa-fw fa-gear txt-color-blue hidden-md hidden-sm hidden-xs"></i> Aksi</th>
                    ...
                    <div class="form-body">
						<div class="form-group has-success">
							...
							<button type="button" id="btnCari" onclick="cari()" class="btn btn-primary" style="margin-top: -6px;margin-left: -11px;">
								...
								<i class="fa fa-search"></i> Cek Tarif<span id="loadtarif"></span>
							</button>
							</div>
						</div>
                        <div class="form-group has-success">
                    ...
                    <table id="datatable_pengirim" class="table table-striped table-bordered table-hover" width="100%">
						<thead>			                
							<tr>
								...
								<th data-class="expand"><i class="fa fa-fw fa-tags text-muted hidden-md hidden-sm hidden-xs"></i> Pengirim</th>
								<th data-class="phone" ><i class="fa fa-fw fa-tag text-muted hidden-md hidden-sm hidden-xs"></i>Nama</th>
                    ...
                    <table id="datatable_penerima" class="table table-striped table-bordered table-hover" width="100%">
						<thead>			                
							<tr>
								...
								<th data-hide="phone" ><i class="fa fa-fw fa-barcode text-muted hidden-md hidden-sm hidden-xs"></i> Perusahaan</th>
								<th data-hide="phone" ><i class="fa fa-fw fa-barcode text-muted hidden-md hidden-sm hidden-xs"></i> Alamat</th>
								<th data-class="phone" ><i class="fa fa-fw fa-barcode text-muted hidden-md hidden-sm hidden-xs"></i> Kota/Kab</th>
  ...
  const Item = ({id}) => `
        <div class="koli-item" id="koli-item-${id}">
			...
			<div class="col-md-4" >
				<div class="input-group">
					<span class="input-group-addon"><i class="fa fa-long-arrow-down fa-fw"></i></span>
					<input class="form-control" placeholder="P" type="text" name="p${id}" id="p${id}" style="width:55px;" onkeyup="hitung_volumex(${id});">
					<span class="input-group-addon"><i class="fa fa-long-arrow-right fa-fw"></i></span>
					<input class="form-control" placeholder="L" type="text" name="l${id}" id="l${id}" style="width:55px;" onkeyup="hitung_volumex(${id});">
					<span class="input-group-addon"><i class="fa fa-long-arrow-up fa-fw"></i></span>
					<input class="form-control" placeholder="T" type="text" name="t${id}" id="t${id}" onkeyup="hitung_volumex(${id});">
					<span class="input-group-addon"><i class="fa fa-check"></i></span>
				</div>
			</div>
			<div class="col-md-5">
				<div class="input-group">
					<input class="form-control iVol"  placeholder="Volume" readonly type="text" name="vol${id}" id="vol${id}">
					<span class="input-group-addon">cm<sup>3</sup></span>

					
					<input class="form-control iBerat" placeholder="Berat Barang (kg)" type="text" name="beratx" id="berat0" onkeyup="updateBerat()" onkeypress="return isNumberKey(event)">
					<span class="input-group-addon">kg</span>
...
function updateTotal(){
	//var totalkoli = $('.koli-item').length;
	//$('#koli').val(totalkoli);
	var vol = 0;
	var value = 0;
	$('.iVol').each(function(){
