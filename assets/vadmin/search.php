		...
		<div class="col-xs-12 col-sm-7 col-md-7 col-lg-12">
			...
			foreach($record_resi->result() as $k){
				echo"<div class='alert alert-warning fade in'>
						...
						<strong>OK</strong> Resi : <strong>".$k->resi."</strong><br/>
						Tujuan : Tn/Nn. ".$k->penerima."  /  $k->telp.<br/>
						Alamat : ".$k->alamat."
						Kecamatan ".$this->app_model->find_kec($k->kec_id)." ".$this->app_model->find_kokab(substr($k->kec_id,0,4)).", ".$this->app_model->find_prov(substr($k->kec_id,0,2))." <br/></div>";
