		...
		<article class="col-sm-12 col-md-12 col-lg-12">
			...
			<div class="jarviswidget" id="wid-id-4" data-widget-editbutton="false" data-widget-custombutton="false">
				...
				<header>
					...
					<h2>Laporan Stok Obat Detail</h2>				
...
function cari() {
	...
	var id = {tgl1:tgl1,tgl2:tgl2,obat_id:obat_id};
	$.ajax({
			type: "POST",
			url : "<?php echo base_url().'cadmin/laporan/cetak_stokobat';?>",
			data: id,
			beforeSend: function(){
			   // $("#loaderDiv").show();
			   loading.fadeIn();						
