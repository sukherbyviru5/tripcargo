					...
					<!-- widget content -->
						...
						<div id="smart-form-register" class="smart-form" novalidate="novalidate">
								...
								<section class="col-sm-3">
									...
									<input type="text" name="resi" placeholder="Nomor Resi" class="form-control" placeholder="XXX-9999999" name="resi" id="resi" data-mask="***-9999999" data-mask-placeholder= "X">
									</label>
								</section>
								<section class="col-sm-3">
